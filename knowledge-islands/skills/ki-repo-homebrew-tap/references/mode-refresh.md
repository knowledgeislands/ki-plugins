...
_On-demand procedure for ki-repo-homebrew-tap's REFRESH mode. The cadence and source list are declared in [`sources.md`](sources.md). The full standard lives in [`standards-homebrew-tap.md`](standards-homebrew-tap.md)._
