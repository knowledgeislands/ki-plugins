...
_On-demand procedure for ki-repo-homebrew-tap's CONFORM mode. The host publishes only the bounded marker proposal; formula, README, checksum, repository, and external Homebrew work remains explicit._
