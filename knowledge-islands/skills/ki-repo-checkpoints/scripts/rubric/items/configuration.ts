...
const CONFIG_1: RubricItem<OutcomeContext> = {
  ...
  description:
    'The optional `ki-repo-checkpoints` declaration is an empty capability marker. It carries no runtime, session, retention, or lifecycle options; repository policy and optional adapters remain separate owners.',
  sources: [SOURCE],
  mechanical: {
    level: 'WARN',
