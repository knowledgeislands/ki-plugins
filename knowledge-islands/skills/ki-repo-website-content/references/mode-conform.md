...
_On-demand procedure for ki-repo-website-content's CONFORM mode. The host publishes only bounded `.ki.toml` and `.gitignore` proposals; source scaffolding, builds, deployments, and other external work remain explicit._
