...
External UI changes, organization policy, remote deployment, and sandbox-portability work remain report-only. No ki-repo-mcp conform action mutates these surfaces.
