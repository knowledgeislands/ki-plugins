...
4. Update the standard and family definitions where evidence changed, regenerate with `ki dev skill rubric ki-repo-plugins --write`, and bump the source review dates.
