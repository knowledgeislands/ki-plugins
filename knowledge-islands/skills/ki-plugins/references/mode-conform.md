...
2. For any generated-content finding, run `bun skills/environment/ki-binding/scripts/build-plugin.ts <repo>` from the harness. Review the complete target diff; the generator owns `.claude-plugin/` and `knowledge-islands/`.
