...
export type AgendaCycleOutcome =
...
export const evaluateAgendaCycle = ({ authorisation, repository, items }: AgendaCycleInput): AgendaCycleOutcome => {
  ...
  const resolved = named as AgendaItem[]
