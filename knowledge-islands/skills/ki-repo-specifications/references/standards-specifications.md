...
KI Specifications is a normal Knowledge Islands repository with one additional structural identity. It declares a keyless `[skills.ki-repo-specifications]` table and exposes seven stable top-level areas:
