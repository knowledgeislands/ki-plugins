...
- `ki-repo-website` **emits** a portable `dist/` (relative internal links, `assets/css/main.css`, sitemap/robots for a public site). This skill **serves** it by pointing `assets.directory` at it.
...
- **Building the `dist/`** → `ki-repo-website`.
