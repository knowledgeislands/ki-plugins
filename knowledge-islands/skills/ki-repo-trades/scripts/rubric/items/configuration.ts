...
const CONFIG_1: RubricItem<OutcomeContext> = {
  ...
  mechanical: {
    ...
    remediation: {
      class: 'diagnostic',
      guidance: 'Correct the local ki-repo-trades route declaration, then rerun the audit.'
    },
