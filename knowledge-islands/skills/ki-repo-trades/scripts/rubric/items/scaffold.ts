...
const SCAFFOLD_1: RubricItem<ScaffoldContext> = {
  ...
  description:
    'A repository declaring ki-repo-trades carries the two `_TRADES` directories and their canonical README orientation beneath the generic working areas owned by ki-repo.',
  sources: [SOURCE],
  mechanical: {
    level: 'FAIL',
