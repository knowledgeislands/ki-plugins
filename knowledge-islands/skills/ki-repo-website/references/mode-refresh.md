...
_On-demand procedure for ki-repo-website's REFRESH mode. It performs research and proposes an authored change; the hosted rubric does not fetch sources or rewrite its own contract._
