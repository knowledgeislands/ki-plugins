---
name: ki-repo-kb-streams-curator
description: >
...
- **Defer**: DR authoring for decisions surfaced by a proposal → [[skills.ki-decision-author]]; skill changes in a proposal → [[skills.ki-skills-lead]]; KB structural changes → [[skills.ki-repo-kb-curator]]; toolchain/repo changes → [[skills.ki-engineering-lead]].
